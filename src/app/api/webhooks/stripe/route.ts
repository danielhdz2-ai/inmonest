...
export async function POST(req: NextRequest) {
  ...
  const STRIPE_SERVICES: Record<string, { name: string; price_eur: number }> = {
    ...
    'alquiler-habitacion':   { name: 'Contrato de Alquiler de Habitación',     price_eur: 120 },
    'reserva-alquiler':      { name: 'Contrato de Reserva de Alquiler',        price_eur: 61  },
    'rescision-alquiler':    { name: 'Contrato de Rescisión de Alquiler',      price_eur: 120 },
    'liquidacion-fianza':    { name: 'Liquidación de Fianza',                  price_eur: 120 },
    'alquiler-habitaciones': { name: 'Contrato de Alquiler de Habitación',     price_eur: 120 },
    'alquiler-local-comercial': { name: 'Contrato de Alquiler de Local Comercial', price_eur: 145 },
    'alquiler-garaje-trastero': { name: 'Contrato de Alquiler de Garaje o Trastero', price_eur: 130 },
    ...
    'arras-parking-garage':   { name: 'Contrato de Arras para Compraventa de Parking o Garaje', price_eur: 145 },
    ...
    'revision-alquiler':                   { name: 'Revisión de Contrato de Alquiler',                 price_eur: 120 },
    ...
    'pack-arras-revision-documental':      { name: 'Pack Arras Plus Comprador',   price_eur: 450 },
    'pack-arras-plus-vendedor':            { name: 'Pack Arras Plus Vendedor',    price_eur: 450 },
