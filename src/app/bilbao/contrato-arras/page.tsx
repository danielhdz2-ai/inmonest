...
export const metadata: Metadata = {
  title: 'Contrato de Arras en Bilbao 【145€】 Redactado por Abogados | Inmonest',
  description: 'Contrato de arras penitenciales en Bilbao. Redactado por abogados especializados en derecho inmobiliario. Revisión de nota simple incluida. Entrega en 48h.',
  alternates: {
