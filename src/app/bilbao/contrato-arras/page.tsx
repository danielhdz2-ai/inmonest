...
export const metadata: Metadata = {
  title: 'Contratar Contrato de Arras en Bilbao 【145€】 Gestoría Experta | Inmonest',
  description: '¿Necesitas un contrato de arras en Bilbao? Redacción personalizada por gestoría inmobiliaria experta en 48h. Precio fijo 145€. Bilbao, Getxo, Barakaldo.',
  keywords: ['contratar contrato arras Bilbao', 'comprar contrato arras Bilbao', 'solicitar contrato arras País Vasco', 'precio contrato arras Bilbao', 'gestoría contrato arras Bizkaia'],
  alternates: {
    canonical: `${BASE_URL}/bilbao/contrato-arras`,
  },
  openGraph: {
    title: 'Contrato de Arras en Bilbao - 145€ | Inmonest',
    description: 'Contrato de arras penitenciales en Bilbao. Gestoría inmobiliaria experta. 48h. 145€.',
    url: `${BASE_URL}/bilbao/contrato-arras`,
    type: 'website',
    siteName: 'Inmonest',
    locale: 'es_ES',
    images: [{ url: `${BASE_URL}/gestoria1.jpg`, width: 1200, height: 630, alt: 'Contrato de arras Bilbao' }],
  },
}
...
export default function ContratoArrasBilbaoPage() {
  const schemaJson = {
    ...
    '@type': 'Service',
    name: 'Contrato de Arras Penitenciales en Bilbao',
    description: 'Redacción de contrato de arras para compraventa de inmuebles en Bilbao. Gestoría inmobiliaria experta en contratos de compraventa.',
    provider: {
      '@type': 'Organization',
      name: 'Inmonest',
      url: BASE_URL,
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: '¿El contrato de arras es válido en todo el País Vasco?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Sí, el contrato de arras penitenciales es válido en todo el País Vasco (Bilbao, Vitoria, Donostia). Se rige por el Código Civil español.',
        },
      },
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: '¿Cuánto suele ser la señal de arras en Bilbao?',
        acceptedAnswer: {
          '@type': 'Answer',
  ...
  return (
    <>
      ...
      <section className="relative h-[400px] sm:h-[480px] overflow-hidden">
        <Image
          src="/gestoria1.jpg"
          alt="Contrato de arras en Bilbao"
          fill
          priority
        ...
        <div className="relative h-full max-w-5xl mx-auto px-4 sm:px-6 flex flex-col justify-end pb-12">
          <nav className="flex items-center gap-1.5 text-xs text-white/50 mb-4">
            ...
            <span>/</span>
            <span className="text-white/80">Contrato de Arras Bilbao</span>
          </nav>
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3 max-w-2xl">
            Contrato de Arras Penitenciales en Bilbao
          </h1>
          <p className="text-white/80 text-lg max-w-xl mb-5">
            El estándar de oro en la compraventa de inmuebles en Bilbao y Bizkaia
          </p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-orange-50 border-l-4 border-[#c9a84c] p-4 rounded-r-lg mb-6">
              <p className="text-gray-800 font-semibold text-lg">¿Necesitas redactar un Contrato de Arras Penitenciales en Bilbao?</p>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-[#fdf8ee] border border-[#e8d48a] rounded-2xl p-6 space-y-4">
              <p className="text-sm text-[#7a5c1e] font-medium uppercase tracking-wide">Compraventa · Bilbao</p>
              ...
              <a
                href="https://wa.me/34641009947?text=Hola,%20necesito%20un%20contrato%20de%20arras%20en%20Bilbao"
                target="_blank"
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              ...
              {
                q: '¿Cuánto suele ser la señal de arras en Bilbao?',
        ...
        <section className="bg-[#0d1a0f] rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-white mb-3">¿Listo para solicitar tu contrato de arras en Bilbao?</h2>
