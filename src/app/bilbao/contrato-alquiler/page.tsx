...
export const metadata: Metadata = {
  title: 'Contratar Contrato de Alquiler LAU en Bilbao 【120€】 Gestoría Experta | Inmonest',
  description: '¿Necesitas un contrato de alquiler LAU en Bilbao? Redacción personalizada por gestoría inmobiliaria experta en 48h. Precio fijo 120€. Bilbao, Getxo, Barakaldo.',
  keywords: ['contratar contrato alquiler Bilbao', 'comprar contrato alquiler Bilbao', 'solicitar contrato alquiler LAU País Vasco', 'precio contrato alquiler Bilbao', 'gestoría contrato alquiler Bizkaia'],
  alternates: {
    canonical: `${BASE_URL}/bilbao/contrato-alquiler`,
  },
  openGraph: {
    title: 'Contrato de Alquiler LAU en Bilbao - 120€ | Inmonest',
    description: 'Contrato de alquiler vivienda en Bilbao. Gestoría inmobiliaria experta. LAU + Ley Vivienda 2026. 48h. 120€.',
    url: `${BASE_URL}/bilbao/contrato-alquiler`,
    type: 'website',
    siteName: 'Inmonest',
    locale: 'es_ES',
    images: [{ url: `${BASE_URL}/gestoria/gestoria7.jpg`, width: 1200, height: 630, alt: 'Contrato de alquiler Bilbao' }],
  },
}
...
export default function ContratoAlquilerBilbaoPage() {
  const schemaJson = {
    ...
    '@type': 'Service',
    name: 'Contrato de Alquiler de Vivienda (LAU) en Bilbao',
    description: 'Redacción de contrato de alquiler de vivienda en Bilbao y País Vasco. Adaptado a LAU y Ley de Vivienda 2026. Gestoría inmobiliaria experta.',
    provider: {
      '@type': 'Organization',
      name: 'Inmonest',
      url: BASE_URL,
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: '¿Cuánto puede actualizarse el alquiler cada año en Bilbao?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Desde 2024, los grandes tenedores están limitados al IPC negociado (máx. 3%). Para pequeños propietarios en Bilbao y Bizkaia, el límite es el IPC + 2%. Nuestro contrato incorpora la fórmula correcta según tu caso.',
        },
      },
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: '¿Qué fianza es obligatoria en el País Vasco?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Una mensualidad de renta como fianza legal mínima, que debe depositarse en el organismo autonómico del País Vasco. Adicionalmente se pueden acordar garantías adicionales (hasta 2 mensualidades según la LAU).',
        },
      },
      {
        '@type': 'Question',
        name: '¿El contrato es válido en todo el País Vasco?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Sí, el contrato de alquiler LAU es válido en todo el País Vasco (Bilbao, Getxo, Barakaldo, Portugalete, San Sebastián, Vitoria). Se adapta a la legislación estatal y autonómica vigente.',
        },
      },
    ],
  }
    ...
    <>
      ...
      <section className="relative h-[400px] sm:h-[480px] overflow-hidden">
        <Image
          ...
          alt="Contrato de alquiler en Bilbao"
          fill
          priority
        ...
        <div className="relative h-full max-w-5xl mx-auto px-4 sm:px-6 flex flex-col justify-end pb-12">
          <nav className="flex items-center gap-1.5 text-xs text-white/50 mb-4">
            ...
            <span>/</span>
            <span className="text-white/80">Contrato de Alquiler Bilbao</span>
          </nav>
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3 max-w-2xl">
            Contrato de Alquiler de Vivienda (LAU) en Bilbao
          </h1>
          <p className="text-white/80 text-lg max-w-xl mb-5">
            Adaptado a la Ley de Vivienda 2026 y LAU vigente para Bilbao y País Vasco
          </p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-orange-50 border-l-4 border-[#c9a84c] p-4 rounded-r-lg mb-6">
              <p className="text-gray-800 font-semibold text-lg">¿Necesitas redactar un Contrato de Alquiler de Vivienda (LAU) en Bilbao?</p>
            ...
            <div>
              <h3 className="font-semibold text-gray-800 mb-3">¿Para quién es este contrato en Bilbao?</h3>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-[#fdf8ee] border border-[#e8d48a] rounded-2xl p-6 space-y-4">
              <p className="text-sm text-[#7a5c1e] font-medium uppercase tracking-wide">Alquiler · Bilbao</p>
              ...
              <a
                href="https://wa.me/34641009947?text=Hola,%20necesito%20un%20contrato%20de%20alquiler%20en%20Bilbao"
                target="_blank"
        ...
        <section className="bg-[#0d1a0f] rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-white mb-3">¿Listo para solicitar tu contrato de alquiler en Bilbao?</h2>
