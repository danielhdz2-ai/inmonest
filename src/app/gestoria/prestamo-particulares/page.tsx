  ...
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                Contrato de préstamo entre <span className="text-gold-500">particulares</span>
              </h1>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-10 text-center">
            <Link
              href={SOLICITAR_URL}
              className="inline-flex px-8 py-4 rounded-lg bg-gold-500 text-white font-semibold hover:bg-gold-600 transition-colors"
            >
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <GestoriaCtaBanner
            eyebrow="Contrato profesional"
            title="Formaliza tu préstamo privado hoy"
            description={`Contrato profesional por ${PRECIO}€ IVA incluido. Asesor asignado, nota fiscal y entrega en 48 horas.`}
            ...
            imageSrc={GESTORIA_CTA_BANNERS.prestamo.src}
            imageAlt={GESTORIA_CTA_BANNERS.prestamo.alt}
            imagePosition="left"
          />
        </div>
      </section>
