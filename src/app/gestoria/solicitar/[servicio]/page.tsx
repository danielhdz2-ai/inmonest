...
const SERVICIOS: Record<string, { nombre: string; precio: number; categoria: string; incluye: string[] }> = {
  ...
  'revision-arras':                     { nombre: 'Revisión de Contrato de Arras',                    precio: 45,  categoria: 'Revisión Legal',       incluye: ['Análisis completo de cláusulas', 'Detección de errores registrales', 'Informe de riesgos legales', 'Recomendaciones de negociación', 'Entrega en 24h'] },
  'revision-alquiler':                  { nombre: 'Revisión de Contrato de Alquiler',                 precio: 39,  categoria: 'Revisión Legal',       incluye: ['Verificación Ley Vivienda 2026', 'Detección de cláusulas ilegales', 'Análisis de fianza y garantías', 'Informe de conformidad', 'Entrega en 24h'] },
  'revision-correccion':                { nombre: 'Revisión + Corrección de Contrato',                precio: 89,  categoria: 'Revisión Legal',       incluye: ['Todo lo anterior +', 'Versión corregida del contrato', 'Argumentos legales para negociar', 'Asesoramiento vía email', 'Entrega en 48h'] },
