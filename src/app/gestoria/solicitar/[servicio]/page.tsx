...
const SERVICIOS: Record<string, { nombre: string; precio: number; categoria: string; incluye: string[] }> = {
  ...
  'asesoramiento-arras-venta':          { nombre: 'Asesoramiento Arras hasta Escritura (Vendedores)', precio: 166, categoria: 'Servicios Premium',    incluye: ['Asesor experto de Inmonest asignado', 'Ayuda para recabar toda la documentación', 'Gestión de trámites y gestiones necesarias', 'Acompañamiento desde arras hasta escritura', 'Coordinación con notaría y compradores', 'NO incluye redacción contrato arras (a parte)', 'Ideal para propietarios vendedores'] },
}
