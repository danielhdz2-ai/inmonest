...
const SERVICIOS: Record<string, { nombre: string; precio: number; categoria: string; incluye: string[] }> = {
  ...
  'reserva-compra':         { nombre: 'Contrato de Reserva de Compra',             precio: 61,  categoria: 'Compraventa',           incluye: ['Bloqueo jurídico del inmueble 48-72h', 'Consignación de señal de reserva', 'Condiciones resolutorias incluidas', 'PDF firmable en 24h'] },
  ...
  'venta-completa-reserva-escritura':   { nombre: 'Servicio Completo de Venta: Reserva a Escritura', precio: 666, categoria: 'Servicios Premium',      incluye: ['Gestor personalizado asignado', 'Estudio completo de la operación', 'Redacción de contratos reserva y arras', 'Ayuda para recabar documentación', 'Asesoramiento continuo hasta escritura', 'Coordinación con notaría'] },
  ...
  'asesoria-compra':                    { nombre: 'Asesoría Básica Compra de Vivienda',               precio: 95,  categoria: 'Servicios Premium',    incluye: ['Nota simple + análisis completo', 'Revisión contrato arras', 'Informe de riesgos en PDF', 'Asesoramiento vía email'] },
  'asesoria-compra-premium':            { nombre: 'Asesoría Premium Compra de Vivienda',              precio: 195, categoria: 'Servicios Premium',    incluye: ['Todo lo anterior +', 'Revisión oferta hipoteca', 'Negociación con vendedor/banco', 'Revisión escritura compraventa', 'Soporte WhatsApp hasta firma'] },
  'burofax-desistimiento':              { nombre: 'Burofax de Desistimiento de Alquiler',             precio: 15,  categoria: 'Rescisión y fianzas',  incluye: ['Redacción por abogados', 'Acuse de recibo oficial', 'Comunicación legal válida', 'Entrega en 24h'] },
  'pack-due-diligence-precompra':       { nombre: 'Pack Due Diligence Pre-Compra',                    precio: 168, categoria: 'Servicios Premium',    incluye: ['Revisión actas de comunidad (2 años)', 'Análisis de derramas pendientes', 'Verificación ITE del edificio', 'Nota registral actualizada', 'Información urbanística y licencias', 'Informe ejecutivo PDF en 3-5 días'] },
