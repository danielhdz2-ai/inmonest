  ...
  return (
    <>
        ...
        >
          <div className="max-w-3xl">
            <h1 className="mb-5 text-4xl font-extrabold leading-[1.1] sm:text-5xl lg:text-6xl">
              Gestoría Inmobiliaria <span className="text-gold-300">Barcelona</span>
            ...
            <p className="mb-8 max-w-2xl text-lg leading-relaxed text-white/85 sm:text-xl">
              <strong>Gestoría inmobiliaria para particulares</strong> en Barcelona. Te acompañamos en la compra o
              venta con un asesor experto asignado, sin comisiones abusivas de agencias (3-5%) y con contratos
              redactados por gestores expertos.
            </p>
      ...
      <GestoriaHubConversionFooter
        ...
        ctaTitulo="¿Vas a alquilar o comprar en Barcelona?"
        ctaTexto="Normativa catalana y zonas tensionadas: empieza por el contrato que necesitas o llama a un gestor."
      />
    </>
  )
}
