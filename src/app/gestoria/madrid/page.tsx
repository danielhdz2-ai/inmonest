  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        >
          <div className="max-w-3xl">
            <h1 className="mb-5 text-4xl font-extrabold leading-[1.1] sm:text-5xl lg:text-6xl">
              Gestoría Inmobiliaria <span className="text-gold-300">Madrid</span>
            ...
            <p className="mb-8 max-w-2xl text-lg leading-relaxed text-white/85 sm:text-xl">
              <strong>Gestoría inmobiliaria para particulares</strong> en Madrid. Asesor experto asignado, sin
              comisiones de agencia (3-5%) y contratos redactados por gestores especializados en el mercado madrileño.
            </p>
        ...
        <ComprarConSeguridad ciudad="Madrid" ciudadSlug="madrid" />
