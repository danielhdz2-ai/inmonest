          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                <a
                  href="https://wa.me/34624177966?text=Hola,%20quiero%20vender%20mi%20piso%20a%20particular%20y%20necesito%20acompañamiento"
                  target="_blank"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border-t-4 border-[#c9962a]">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Asesoramiento continuo</h3>
              </div>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-[#c9962a] mt-1">✓</span>
                  <span>Tu gestor disponible por email, teléfono y WhatsApp</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#c9962a] mt-1">✓</span>
                  <span>Resolución de dudas en cada fase del proceso</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#c9962a] mt-1">✓</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-[#c9962a] mt-1">✓</span>
                  <span>Seguimiento hasta firma de escrituras</span>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-[#c9962a] to-[#a87a20]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://wa.me/34624177966?text=Hola,%20quiero%20información%20sobre%20el%20servicio%20de%20acompañamiento%20de%20venta"
              target="_blank"
              rel="noopener noreferrer"
