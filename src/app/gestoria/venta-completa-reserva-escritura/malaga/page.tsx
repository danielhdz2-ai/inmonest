...
export default function VentaCompletaMalagaPage() {
  const schemaJson = buildVentaCompletaServiceSchema('Málaga', 'malaga')
  const breadcrumbSchema = buildVentaCompletaBreadcrumbSchema('Málaga', 'malaga')
  ...
  return (
    <>
      ...
      <TestimoniosSection landing="venta-completa-malaga" layout="stack" hideRating />
