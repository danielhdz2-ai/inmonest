...
export default function VentaCompletaValladolidPage() {
  const schemaJson = buildVentaCompletaServiceSchema('Valladolid', 'valladolid')
  const breadcrumbSchema = buildVentaCompletaBreadcrumbSchema('Valladolid', 'valladolid')
  ...
  return (
    <>
      ...
      <GestorContactBanner />
      <TestimoniosSection landing="venta-completa-valladolid" layout="stack" hideRating />
      ...
      <CiudadHubServiciosGrid
        ciudad="Valladolid"
        ciudadSlug="valladolid"
        subtitulo="Redactados por abogados colegiados con experiencia en el mercado inmobiliario vallisoletano."
