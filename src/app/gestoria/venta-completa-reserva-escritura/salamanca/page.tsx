...
export default function VentaCompletaSalamancaPage() {
  const schemaJson = buildVentaCompletaServiceSchema('Salamanca', 'salamanca')
  const breadcrumbSchema = buildVentaCompletaBreadcrumbSchema('Salamanca', 'salamanca')
  ...
  return (
    <>
      ...
      <GestorContactBanner />
      <TestimoniosSection landing="venta-completa-salamanca" layout="stack" hideRating />
