...
export const metadata: Metadata = {
  title: 'Due Diligence Pre-Compra Barcelona | Gestor Revisa Todo Antes de Comprar',
  description: '¿Compras piso en Barcelona de particular? Gestor experto revisa toda la documentación hasta escritura: cargas, deudas, hipotecas, cédula habitabilidad. Evita sorpresas. 350€.',
  keywords: 'due diligence inmobiliaria barcelona, revisar documentacion compra piso, gestor compra vivienda barcelona, evitar estafa compra piso, comprar piso particular barcelona, revision juridica vivienda',
  alternates: {
    canonical: `${BASE_URL}/gestoria/due-diligence-precompra/barcelona`,
  },
  openGraph: {
    title: 'Due Diligence Pre-Compra Barcelona — Gestor Experto Revisa Todo',
    description: 'Gestor inmobiliario experto revisa toda la documentación de la vivienda que vas a comprar en Barcelona. Evita sorpresas y riesgos. 350€.',
    url: `${BASE_URL}/gestoria/due-diligence-precompra/barcelona`,
    type: 'website',
    siteName: 'Inmonest',
    locale: 'es_ES',
    images: [{ url: `${BASE_URL}/keys.jpg`, width: 1200, height: 630, alt: 'Due Diligence Pre-Compra Barcelona' }],
  },
}

export const revalidate = 86400

export default function DueDiligenceBarcelonaPage() {
  const schemaJson = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Pack Due Diligence Pre-Compra en Barcelona',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 4, name: 'Barcelona', item: `${BASE_URL}/gestoria/due-diligence-precompra/barcelona` },
    ],
  }
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-blue-50 via-white to-blue-50 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-gray-600 mb-6">
            ...
            <span>/</span>
            <span className="text-[#c9962a] font-semibold">Due Diligence Barcelona</span>
          </nav>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                ¿Compras piso de <span className="text-[#c9962a]">particular a particular en Barcelona</span>?
              </h1>
            ...
            <div className="relative">
              <Image
                src="/keys.jpg"
                alt="Due Diligence compra piso Barcelona"
                width={600}
                height={400}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white p-8 rounded-2xl border border-purple-100 shadow-sm">
              <div className="text-4xl mb-4">🏗️</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Documentación Técnica y Generalitat</h3>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>Cédula de habitabilidad vigente (obligatorio Generalitat)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>Certificado energético actualizado</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>ITE (Inspección Técnica del Edificio) Barcelona</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>Licencias de obra (reformas y ampliaciones)</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Pagas 350€ y te asignamos un <strong>gestor inmobiliario experto en Barcelona</strong>. Te contactará en menos de 24h.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Tu gestor te pide la documentación que tenga el vendedor y solicita él mismo <strong>nota simple, certificados y toda la documentación oficial</strong> necesaria (incluso a la Generalitat si hace falta).
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  El gestor <strong>revisa TODO</strong>: cargas, deudas, hipotecas, comunidad, IBI, suministros, cédula de habitabilidad (obligatoria en Catalunya), ITE, certificado energético... Detecta cualquier problema ANTES de firmar.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-green-50 to-white p-6 rounded-xl border border-green-100">
              <p className="text-lg">
                ✅ <strong>Compras una vivienda con muchos años</strong> y quieres verificar que todo esté en regla (ITE, reformas, licencias, cédula de habitabilidad...)
              </p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">
            Servicio en toda Barcelona y área metropolitana
          </h2>
          <p className="text-lg text-gray-600 mb-8 text-center">
            Nuestros gestores conocen las <strong>particularidades de cada distrito y normativa de la Generalitat</strong>
          </p>

          <div className="grid md:grid-cols-3 gap-4 text-center text-gray-700">
            <div className="bg-white p-4 rounded-lg shadow-sm">Eixample</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Gràcia</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Sarrià-Sant Gervasi</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Les Corts</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Sants-Montjuïc</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Ciutat Vella</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Sant Martí</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Horta-Guinardó</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Sant Andreu</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">L'Hospitalet</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Badalona</div>
            <div className="bg-white p-4 rounded-lg shadow-sm">Sabadell</div>
          </div>
        </div>
      </section>
      ...
      <GestorContactBanner />
      <TestimoniosSection landing="due-diligence-barcelona" />

      {/* CTA Final */}
      <section className="py-16 px-4 bg-gradient-to-br from-[#1a0d00] to-[#2e1900] text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Compra tu piso en Barcelona con total seguridad
          </h2>
