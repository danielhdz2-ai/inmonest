          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                Contrato de alquiler de <span className="text-gold-500">habitación</span> para particulares
              </h1>
          ...
          <div className="bg-slate-50 border border-gray-200 rounded-2xl p-8">
            ...
            <div className="flex gap-5 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gold-700 font-medium mb-3">Gestora inmobiliaria · Alquiler de habitaciones</p>
            ...
            <table className="w-full border-collapse bg-white shadow-sm rounded-xl overflow-hidden text-sm">
              ...
              <tbody>
                ...
                <tr className="bg-cream-100">
                  ...
                  <td colSpan={2} className="p-4 text-center font-bold text-gold-700">
