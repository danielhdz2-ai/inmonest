...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Pisos de particulares en Sevilla sin comisión',
...
const TESTIMONIOS = [
  { nombre: 'Antonio R.', barrio: 'Triana', texto: 'Encontré piso en Triana en 1 semana. Sin agencia, sin comisiones.', ahorro: '1.700€' },
  { nombre: 'Carmen S.', barrio: 'Centro', texto: 'Compré mi piso sin pagar comisión. Todo super claro y rápido.', ahorro: '4.500€' },
]

const FAQS = [
  { q: '¿Por qué alquilar sin agencia en Sevilla?', a: 'Ahorras 1-2 meses de comisión (800-1.600€ de media). Proceso más directo.' },
