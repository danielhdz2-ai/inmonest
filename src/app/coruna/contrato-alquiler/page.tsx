...
export const metadata: Metadata = {
  title: 'Contratar Contrato de Alquiler LAU en A Coruña 【120€】 Gestoría Experta | Inmonest',
  description: '¿Necesitas un contrato de alquiler LAU en A Coruña? Redacción personalizada por gestoría inmobiliaria experta en 48h. Precio fijo 120€. A Coruña, Santiago, Ferrol.',
  ...
  openGraph: {
    ...
    description: 'Contrato de alquiler vivienda en A Coruña. Gestoría inmobiliaria experta. LAU + Ley Vivienda 2026. 48h. 120€.',
...
export default function ContratoAlquilerCorunaPage() {
  const schemaJson = {
    ...
    description: 'Redacción de contrato de alquiler de vivienda en A Coruña y Galicia. Adaptado a LAU y Ley de Vivienda 2026. Gestoría inmobiliaria experta.',
    provider: {
      '@type': 'Organization',
      name: 'Inmonest',
      url: BASE_URL,
