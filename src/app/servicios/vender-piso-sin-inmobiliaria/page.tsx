    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative bg-gradient-to-br from-[#0f0a05] via-[#1f1410] to-[#0f0a05] pt-32 pb-24 px-4 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex justify-center mb-8">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-gold-500/20 to-[#f4c94a]/20 border border-gold-500/60 backdrop-blur-sm text-white px-6 py-3 rounded-full shadow-xl">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white text-center mb-8 leading-[1.1]">
              Vende tu piso{' '}
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-gold-500 to-[#f4c94a]">
            ...
            <div className="max-w-4xl mx-auto mb-12">
              <p className="text-xl md:text-2xl text-white/90 text-center leading-relaxed font-medium">
                <strong className="text-gold-500 font-bold">Inmonest Gestoría Inmobiliaria</strong> es la alternativa digital 
                ...
                <strong className="text-gold-300">tarifa plana de 687€</strong>.
              </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href={`tel:+34${PHONE}`}
                className="group inline-flex items-center justify-center gap-3 bg-gold-500 hover:bg-[#f4c94a] text-white px-10 py-5 rounded-2xl font-bold text-lg shadow-2xl transition-all transform hover:scale-105 hover:shadow-[#c9a84c]/50 border-2 border-gold-300/30"
              >
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
                ...
                cuando puedes tener <span className="text-gold-500">lo mismo por 687€</span>?
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-gold-500 to-gold-700 border-4 border-gold-300 rounded-3xl p-8 relative shadow-2xl transform scale-105">
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gold-600 text-white px-6 py-2 rounded-full font-bold text-sm shadow-lg">
                  RECOMENDADO ⭐
                </div>
                <div className="text-center mt-4 mb-6">
                  <div className="text-5xl mb-3">💻</div>
                ...
                <div className="bg-white rounded-xl p-4 text-center shadow-xl">
                  <p className="text-sm text-gray-600 mb-1">Coste total</p>
                  <p className="text-4xl font-black text-gold-500">687€</p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-8 hover:border-gold-500 hover:shadow-xl transition-all">
            ...
            <div className="mt-12 text-center">
              <a
                href={`tel:+34${PHONE}`}
                className="inline-flex items-center gap-3 bg-gold-500 text-white px-10 py-5 rounded-2xl font-bold text-lg shadow-xl hover:bg-gold-600 transition-all transform hover:scale-105"
              >
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-gold-500 hover:shadow-xl transition-all">
        ...
        {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            CTA FINAL
        ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
        <section className="py-24 px-4 bg-gradient-to-br from-gold-500 via-[#a87a20] to-[#8b6518]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={`tel:+34${PHONE}`}
                className="inline-flex items-center justify-center gap-3 bg-white text-gold-500 px-10 py-5 rounded-2xl font-bold text-lg shadow-2xl hover:bg-gray-100 transition-all transform hover:scale-105"
              >
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-gold-600 text-white px-10 py-5 rounded-2xl font-bold text-lg shadow-2xl hover:bg-gold-700 transition-all"
              >
