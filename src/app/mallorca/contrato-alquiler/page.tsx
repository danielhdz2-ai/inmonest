...
const cfg = CONTRATO_ALQUILER_PREMIUM.mallorca
const ciudadImage = getCiudadImage('mallorca')
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${BASE_URL}/mallorca/contrato-alquiler`,
  },
  openGraph: {
    title: cfg.meta.ogTitle,
    description: cfg.meta.ogDescription,
    url: `${BASE_URL}/mallorca/contrato-alquiler`,
    type: 'website',
    siteName: 'Inmonest',
    locale: 'es_ES',
...
export default function ContratoAlquilerMallorcaPage() {
