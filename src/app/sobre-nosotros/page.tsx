          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            <div>
              <Image
                ...
                alt="Gestoría inmobiliaria Inmonest — asesoramiento cercano"
                width={600}
                height={450}
            ...
            <div>
              <div className="inline-block bg-amber-100 text-amber-800 px-3 py-1 rounded-full text-sm font-semibold mb-4">
                🤝 Gestoría con trato humano
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                1. Tu asesor experto en derecho inmobiliario
              </h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                No te dejamos solo con un formulario. En Inmonest tienes un <strong>asesor experto en derecho inmobiliario</strong> al 
                que puedes consultar todas las dudas que tengas: ¿este contrato de arras es seguro?, ¿qué documentos necesito para vender?, 
                ¿puedo confiar en este comprador? Te respondemos con calma, sin tecnicismos innecesarios y con soluciones reales.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                Somos el <strong>único portal que integra gestoría jurídica especializada</strong> en derecho inmobiliario. 
                No somos una agencia: somos tu gestoría de confianza, con precios claros y sin comisiones sobre tu operación.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6">
                ...
                <a
                  href="https://wa.me/34641008847?text=Hola,%20tengo%20una%20duda%20sobre%20gestoría%20inmobiliaria"
                  target="_blank"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            <div className="text-center md:text-left">
              ...
              <p className="text-lg text-gray-700 mt-4 max-w-xl">
                Detrás de cada contrato y cada consulta hay personas reales que entienden lo estresante que puede ser 
                comprar, vender o alquilar. Por eso te atendemos con cercanía, paciencia y profesionalidad.
              </p>
            </div>
            <div>
              <Image
                src="/gestoria1.jpg"
                alt="Equipo de gestoría Inmonest — asesores en derecho inmobiliario"
                width={600}
                height={400}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border-t-4 border-[#c9962a]">
              ...
              <p className="text-gray-600">
                Asesores expertos en derecho inmobiliario que resuelven tus dudas con trato cercano: 
                contratos, arras, compraventas y todo el proceso hasta notaría.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="text-5xl mb-4">📊</div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-4">
            Estamos aquí para ayudarte. Si tienes cualquier duda sobre una operación inmobiliaria, 
            un asesor experto en derecho inmobiliario te responde con claridad y sin compromiso.
          </p>
          <p className="text-gray-500 text-sm mb-8">
            Llámanos, escríbenos por WhatsApp o envíanos un email. Te atendemos en menos de 24 horas.
          </p>
