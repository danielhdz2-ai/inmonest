...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Pisos de particulares en Málaga sin comisión',
...
const TESTIMONIOS = [
  ...
  { nombre: 'Elena P.', barrio: 'Centro', texto: 'Compré mi piso sin comisión. Proceso rápido y transparente.', ahorro: '5.500€' },
]

const FAQS = [
  { q: '¿Por qué alquilar sin agencia en Málaga?', a: 'Ahorras 1-2 meses de comisión (1.000-2.400€). Proceso más directo con propietario.' },
  { q: '¿Los pisos son reales?', a: 'Sí, verificamos cada anuncio con IA que valida fotos y datos catastrales.' },
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center text-white mb-12">
            <div className="inline-block bg-gold-500/30 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-semibold border border-gold-500/40 mb-6 text-gold-300">
              🏠 Málaga • Particulares • Sin Comisión
            </div>
            <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight">
              Pisos de particulares<br />
              <span className="text-gold-300">sin comisión</span> en Málaga
            </h1>
