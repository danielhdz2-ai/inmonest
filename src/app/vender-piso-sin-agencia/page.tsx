  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        {/* HERO */}
        <section className="relative bg-gradient-to-br from-black via-black to-black pt-24 pb-20 px-4 overflow-hidden">
          {/* Background pattern */}
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 border-2 border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-black transition-all"
                  >
