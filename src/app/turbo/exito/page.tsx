    ...
    <>
      ...
      <main className="min-h-screen bg-cream-100 flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <h1 className="text-3xl font-extrabold text-gold-700 mb-3">
            ¡Turbo activado!
          </h1>
          ...
          <div className="bg-white rounded-2xl p-5 border border-gold-300/40 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
            ...
            <Link
              href="/mi-cuenta"
              className="px-6 py-3 border border-gold-300 text-gold-700 rounded-full font-semibold text-sm hover:bg-[#fef0c0] transition-colors"
            >
              Ir a mi cuenta
            </Link>
          </div>
