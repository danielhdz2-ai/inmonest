...
export const metadata: Metadata = {
  title: 'Contratar Contrato de Arras en Asturias 【145€】 Gestoría Experta | Inmonest',
  description: '¿Necesitas un contrato de arras en Asturias? Redacción personalizada por gestoría inmobiliaria experta en 48h. Precio fijo 145€. Oviedo, Gijón, Avilés.',
  keywords: ['contratar contrato arras Asturias', 'comprar contrato arras Oviedo', 'solicitar contrato arras Gijón', 'precio contrato arras Asturias', 'gestoría contrato arras Avilés'],
  alternates: {
    canonical: `${BASE_URL}/asturias/contrato-arras`,
  },
  openGraph: {
    title: 'Contrato de Arras en Asturias - 145€ | Inmonest',
    description: 'Contrato de arras penitenciales en Asturias. Gestoría inmobiliaria experta. 48h. 145€.',
    url: `${BASE_URL}/asturias/contrato-arras`,
    type: 'website',
    siteName: 'Inmonest',
    locale: 'es_ES',
    images: [{ url: `${BASE_URL}/gestoria1.jpg`, width: 1200, height: 630, alt: 'Contrato de arras Asturias' }],
  },
}

export const revalidate = 3600

export default function ContratoArrasAsturiasPage() {
  const schemaJson = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Contrato de Arras Penitenciales en Asturias',
    description: 'Redacción de contrato de arras para compraventa de inmuebles en Asturias. Gestoría inmobiliaria experta en contratos de compraventa.',
    provider: {
      '@type': 'Organization',
      name: 'Inmonest',
      url: BASE_URL,
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: '¿El contrato de arras es válido en toda Asturias?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Sí, el contrato de arras penitenciales es válido en toda España, incluyendo Asturias (Oviedo, Gijón, Avilés, etc.). Se rige por el Código Civil español.',
        },
      },
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: '¿Cuánto suele ser la señal de arras en Asturias?',
        acceptedAnswer: {
          '@type': 'Answer',
  ...
  return (
    <>
      ...
      <section className="relative h-[400px] sm:h-[480px] overflow-hidden">
        <Image
          src="/gestoria1.jpg"
          alt="Contrato de arras en Asturias"
          fill
          priority
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-gray-600 text-sm">
                  ...
                  Compradores en Oviedo, Gijón, Avilés que quieren reservar un inmueble con garantías
                </li>
                <li className="flex items-start gap-2 text-gray-600 text-sm">
                  <span className="text-[#c9a84c] mt-0.5">✓</span>
                  Vendedores en Asturias que desean asegurar la operación sin cerrarla definitivamente
                </li>
                <li className="flex items-start gap-2 text-gray-600 text-sm">
                  <span className="text-[#c9a84c] mt-0.5">✓</span>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-[#fdf8ee] border border-[#e8d48a] rounded-2xl p-6 space-y-4">
              <p className="text-sm text-[#7a5c1e] font-medium uppercase tracking-wide">Compraventa · Asturias</p>
              ...
              <a
                href="https://wa.me/34641009947?text=Hola,%20necesito%20un%20contrato%20de%20arras%20en%20Asturias"
                target="_blank"
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              {
                q: '¿El contrato de arras es válido en toda Asturias?',
                a: 'Sí, el contrato de arras penitenciales es válido en toda España, incluyendo Asturias (Oviedo, Gijón, Avilés, Langreo, Mieres, etc.). Se rige por el Código Civil español.',
              },
              {
              ...
              {
                q: '¿Cuánto suele ser la señal de arras en Asturias?',
        ...
        <section className="bg-[#0d1a0f] rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-white mb-3">¿Listo para solicitar tu contrato de arras en Asturias?</h2>
