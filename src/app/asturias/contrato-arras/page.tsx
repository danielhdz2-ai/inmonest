...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Contrato de arras penitenciales en Asturias. Abogados especializados. 48h. 145€.',
...
export default function ContratoArrasAsturiasPage() {
  const schemaJson = {
    ...
    description: 'Redacción de contrato de arras para compraventa de inmuebles en Asturias. Abogados especializados en derecho inmobiliario.',
    provider: {
      '@type': 'Organization',
      name: 'Inmonest',
      url: BASE_URL,
