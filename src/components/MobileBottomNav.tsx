...
export default function MobileBottomNav() {
  ...
  return (
    <nav
      ...
      className="md:hidden fixed inset-x-0 bottom-0 z-[55] border-t border-white/10 bg-forest-950/95 backdrop-blur-xl supports-[backdrop-filter]:bg-forest-950/90"
