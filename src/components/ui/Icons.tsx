/** Iconos SVG boutique — sin dependencias externas */
...
export function Scale({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18M5 7h14M7 7l-2 8h4L7 7zm10 0l-2 8h4l-2-8z" />
    </svg>
  )
}
...
export function BadgeCheck({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4M12 3l2.2 1.1L17 3l1.1 2.8L21 7l-2.9 1.1L17 11l-2.2-1.1L12 11l-1.1-2.9L8 7l2.9-1.2L12 3z" />
    </svg>
  )
}
...
export function Building2({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 21V5a1 1 0 011-1h5v17M14 21V9h5a1 1 0 011 1v11M9 9h.01M9 13h.01M9 17h.01M18 13h.01M18 17h.01" />
    </svg>
  )
}
...
export function FileText({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zM14 2v6h6M16 13H8M16 17H8M10 9H8" />
    </svg>
  )
}
...
export function Gift({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <path strokeLinecap="round" strokeLinejoin="round" d="M20 12v8a2 2 0 01-2 2H6a2 2 0 01-2-2v-8M4 7h16M12 22V7M12 7H7.5a2.5 2.5 0 010-5C11 2 12 7 12 7zm0 0h4.5a2.5 2.5 0 000-5C13 2 12 7 12 7zM4 12h16" />
    </svg>
  )
}
