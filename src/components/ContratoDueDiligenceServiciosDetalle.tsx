...
import { getDueDiligenceServicioMeta } from '@/lib/due-diligence-servicio-registry'
...
export default function ContratoDueDiligenceServiciosDetalle({
  ciudadNombre,
  solicitarHref,
}: Props) {
  const meta = getDueDiligenceServicioMeta()

  return (
    <section
      className="border-t border-gray-100 bg-white"
      aria-labelledby="due-diligence-servicios-titulo"
      id={meta.sectionId}
    >
      <div className="mx-auto max-w-5xl px-4 py-10 sm:py-14">
        <div className="mb-8 text-center">
          ...
          <h2
            id="due-diligence-servicios-titulo"
          ...
          <div className="mx-auto mt-6 inline-flex flex-col items-center rounded-2xl border-2 border-gold-300 bg-[#fdfbf5] px-8 py-4 shadow-sm sm:flex-row sm:gap-6">
            ...
            <p className="max-w-xs text-sm text-gray-600">
              Sin comisión sobre el precio del piso. Trámite 100 % online con gestor real de principio a fin.
            </p>
          </div>
        </div>

        <nav
          aria-label="Pasos del due diligence pre-compra"
      ...
      <div className="border-t border-gray-200 bg-slate-50 px-4 py-12">
        <div className="mx-auto max-w-3xl text-center">
          <p className="mb-6 text-gray-600">
            ¿Quieres verificar el inmueble antes de escriturar? Contrata online y tu gestor empieza en 24 h.
          </p>
          <Link
            href={solicitarHref}
