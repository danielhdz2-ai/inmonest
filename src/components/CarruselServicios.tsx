...
const SERVICIOS: Servicio[] = [
  ...
  { nombre: 'Servicio Completo Compra', precio: 687, categoria: 'Premium', slug: 'compra-completa-reserva-escritura', imagen: '/gestoria/gestoria3.jpg', tiempo: '30d', descripcion: 'Gestión completa de reserva a escritura. Coordinación notaría. Análisis registral y urbanístico. Atención prioritaria.' },
