...
const SERVICIOS: Servicio[] = [
  ...
  { nombre: 'Contrato de Alquiler LAU', precio: 120, categoria: 'Alquiler', slug: 'contrato-alquiler', imagen: '/gestoria4.jpg', tiempo: '48h', descripcion: 'Adaptado a Ley de Vivienda 2026. Para propietarios e inquilinos. Cláusulas personalizadas y protección legal.' },
  ...
  { nombre: 'Revisión de Alquiler', precio: 60, categoria: 'Revisión Legal', slug: 'revision-alquiler', imagen: '/gestoria7.jpg', tiempo: '24h', descripcion: 'Verificamos cumplimiento Ley Vivienda 2026. Detectamos cláusulas ilegales y fianzas abusivas.' },
  { nombre: 'Alquiler de Habitación', precio: 121, categoria: 'Alquiler', slug: 'alquiler-habitaciones', imagen: '/gestoria10.jpg', tiempo: '48h', descripcion: 'Regulación de zonas comunes. Normas de convivencia pactadas. Ideal para pisos compartidos o coliving.' },
  { nombre: 'Rescisión de Alquiler', precio: 73, categoria: 'Rescisión', slug: 'rescision-alquiler', imagen: '/gestoria1.jpg', tiempo: '48h', descripcion: 'Acta de estado del inmueble. Liquidación y devolución de fianza. Evita conflictos al terminar el contrato.' },
  { nombre: 'Análisis de Fraude', precio: 29, categoria: 'Revisión Legal', slug: 'contrato-ilegal', imagen: '/gestoria2.jpg', tiempo: '12h', descripcion: 'Verificación documentación. Detección de señales de fraude. Informe urgente de riesgos críticos en 12h.' },
