...
function LegalLinkRow({
  ...
  return (
    <Link
      ...
      className="flex items-center gap-4 p-4 rounded-xl border border-gray-100 hover:border-[#c9962a]/40 hover:bg-[#fef9e8]/50 transition-colors group min-h-[72px] touch-manipulation"
    >
      <span className="text-2xl flex-shrink-0 w-10 text-center" aria-hidden>
        {icon}
      </span>
      <div className="flex-1 min-w-0">
        <p className="text-sm font-semibold text-gray-900 group-hover:text-[#7a5c1e]">{title}</p>
        <p className="text-xs text-gray-500 mt-0.5">{desc}</p>
      </div>
      <svg
        className="w-5 h-5 text-gray-300 group-hover:text-[#c9962a] flex-shrink-0 transition-colors"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        aria-hidden
    ...
    <div className="space-y-5">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1a1008] to-[#0d1a0f] p-5 sm:p-6 text-white">
        ...
        <div className="relative flex items-start gap-4">
          <div className="w-11 h-11 rounded-xl bg-[#c9962a]/20 border border-[#c9962a]/30 flex items-center justify-center text-xl flex-shrink-0">
            🛡️
          </div>
          <div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex gap-3">
              <span className="text-[#c9962a] flex-shrink-0">✓</span>
              <span>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6">
        ...
        <p className="text-sm text-gray-500 mb-4">
          ...
          <a href="mailto:info@inmonest.com" className="text-[#c9962a] font-medium hover:underline">
            info@inmonest.com
          </a>{' '}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          {RGPD_RIGHTS.map((r) => (
            <div key={r.label} className="rounded-xl bg-[#fef9e8]/60 border border-[#f0dfa0]/50 px-3 py-2.5">
              <p className="text-xs font-bold text-[#7a5c1e]">{r.label}</p>
        ...
        <p className="text-xs text-gray-400 mt-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#c9962a] hover:underline"
          >
