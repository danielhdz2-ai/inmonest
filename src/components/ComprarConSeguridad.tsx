...
export default function ComprarConSeguridad({ ciudad, ciudadSlug }: ComprarConSeguridadProps) {
  ...
  return (
    <section className="py-12 px-4 bg-gradient-to-br from-[#1a2f1c] to-[#0d1a0f] text-white">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-8">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#c9962a] mb-2">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white/10 border border-white/20 rounded-2xl p-6 flex flex-col">
            <p className="text-sm text-[#f4c94a] font-semibold mb-1">Post-arras · Revisión documental</p>
            ...
            <p className="text-2xl font-bold text-[#f4c94a] mb-4">
              350€ <span className="text-sm font-normal text-white/60">IVA incl.</span>
            </p>
            <Link
              href={dueDiligenceHref}
              className="inline-flex justify-center px-6 py-3 rounded-lg bg-[#c9962a] text-[#1a2f1c] font-semibold hover:bg-[#f4c94a] transition-colors"
            >
              {tieneDueDiligence ? `Ver en ${ciudad} →` : 'Ver Due Diligence →'}
            </Link>
          </div>

          <div className="bg-white/10 border border-[#c9962a]/40 rounded-2xl p-6 flex flex-col ring-1 ring-[#c9962a]/30">
            <p className="text-sm text-[#f4c94a] font-semibold mb-1">Reserva hasta escritura</p>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-4 text-sm">
          <a href="tel:+34745022862" className="text-white/80 hover:text-[#f4c94a] transition-colors">
            📞 745 022 862
          </a>
          <Link
            href="/gestoria/solicitar/compra-completa-reserva-escritura"
            className="text-[#f4c94a] hover:underline font-medium"
          >
            Solicitar online →
          </Link>
        </div>
