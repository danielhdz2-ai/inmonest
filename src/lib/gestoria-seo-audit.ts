...
export const GESTORIA_FUERA_SITEMAP = [
  ...
  '/gestoria/pack-arras-revision-documental/madrid',
  '/gestoria/pack-arras-revision-documental/barcelona',
  '/gestoria/pack-arras-revision-documental/valencia',
  '/gestoria/pack-arras-revision-documental/sevilla',
  '/gestoria/pack-arras-revision-documental/malaga',
  '/gestoria/pack-arras-revision-documental/zaragoza',
  '/gestoria/pack-arras-revision-documental/bilbao',
  '/gestoria/pack-arras-revision-documental/coruna',
  '/gestoria/pack-arras-revision-documental/valladolid',
  '/gestoria/pack-arras-revision-documental/murcia',
  '/gestoria/pack-arras-revision-documental/pamplona',
  ...
  '/gestoria/contrato-alquiler-habitacion/bilbao',
  '/gestoria/contrato-alquiler-habitacion/valencia',
  '/gestoria/contrato-alquiler-habitacion/zaragoza',
  '/gestoria/contrato-alquiler-habitacion/asturias',
  '/gestoria/contrato-alquiler-habitacion/alicante',
  '/gestoria/contrato-alquiler-habitacion/granada',
  '/gestoria/contrato-alquiler-habitacion/salamanca',
  '/gestoria/contrato-alquiler-habitacion/coruna',
  '/gestoria/contrato-alquiler-habitacion/pamplona',
  '/gestoria/contrato-alquiler-habitacion/mallorca',
  '/gestoria/contrato-alquiler-habitacion/murcia',
  '/gestoria/contrato-alquiler-habitacion/valladolid',
  '/gestoria/reserva-compra',
  '/gestoria/alquiler-temporada',
