...
export const GESTORIA_INDEXAR_PRIORIDAD_MEDIA = [
  ...
  '/gestoria/castellon',
  '/castellon/contrato-arras',
  '/castellon/contrato-alquiler',
  '/contratos-inmobiliarios/castellon',
  '/gestoria/due-diligence-precompra/castellon',
...
export const GESTORIA_ENLACES_INDEXACION = [
  ...
  },
  {
    ...
    title: 'Gestoría Castellón',
    description: 'Hub Grao, Plana y litoral. Arras, LAU y due diligence.',
    badge: 'Nuevo',
  },
  {
    href: '/contratos-inmobiliarios/castellon',
    title: 'Contratos inmobiliarios Castellón',
    description: 'Arras, LAU y compraventa entre particulares en Castelló.',
    badge: 'Nuevo',
  },
  {
    href: '/castellon/contrato-arras',
    title: 'Contrato arras Castellón',
    description: 'Arras penitenciales con plazo a notaría. 145€.',
    badge: 'Nuevo',
  },
  {
    href: '/gestoria/due-diligence-precompra/castellon',
    title: 'Due diligence Castellón',
    description: 'Revisión documental antes de la señal. 350€.',
    badge: 'Nuevo',
  },
  {
