...
export const TESTIMONIOS_POR_LANDING: Record<string, Testimonio[]> = {
  ...
  'venta-completa-alicante': pick(8, 12, 10),
  'venta-completa-bilbao': pick(20, 6, 17),
  'venta-completa-zaragoza': pick(5, 16, 17),
  'venta-completa-coruna': pick(10, 13, 1),
  'venta-completa-pamplona': pick(10, 13, 1),
  'venta-completa-murcia': pick(8, 12, 10),
  'venta-completa-granada': pick(8, 12, 10),
  'venta-completa-mallorca': pick(8, 12, 10),
  'pack-arras-vendedor-madrid': pick(1, 13, 12),
  'pack-arras-vendedor-barcelona': pick(1, 13, 12),
  'asesoria-compra-salamanca': pick(10, 13, 1),
  'asesoria-compra-granada': pick(8, 12, 10),
  'due-diligence-alicante': pick(8, 12, 10),
  'due-diligence-murcia': pick(8, 12, 10),
  'due-diligence-pamplona': pick(10, 13, 1),
  'due-diligence-salamanca': pick(10, 13, 1),
  'due-diligence-valladolid': pick(10, 13, 1),
  ...
  'due-diligence-granada': pick(5, 21, 17),
  'due-diligence-mallorca': pick(18, 5, 17),
  ...
  'pack-arras-documental-sevilla': pick(19, 5, 16),
  'pack-arras-documental-malaga': pick(5, 21, 17),
  'pack-arras-documental-zaragoza': pick(7, 11, 18),
  'pack-arras-documental-bilbao': pick(20, 6, 17),
  'pack-arras-documental-coruna': pick(16, 5, 17),
  'pack-arras-documental-valladolid': pick(10, 13, 1),
  'pack-arras-documental-murcia': pick(19, 5, 16),
  'pack-arras-documental-pamplona': pick(7, 11, 18),
  ...
  'alquiler-habitacion-alicante': pick(10, 3, 16),
  'alquiler-habitacion-granada': pick(11, 4, 18),
  'alquiler-habitacion-salamanca': pick(9, 17, 23),
  'alquiler-habitacion-coruna': pick(6, 20, 26),
  'alquiler-habitacion-pamplona': pick(7, 11, 18),
  'alquiler-habitacion-mallorca': pick(10, 16, 24),
  'alquiler-habitacion-murcia': pick(8, 14, 22),
  'alquiler-habitacion-valladolid': pick(9, 17, 25),
  'venta-completa-asturias': pick(10, 22, 6),
  'venta-completa-santander': pick(8, 14, 20),
  'venta-completa-vitoria': pick(7, 11, 18),
  'venta-completa-san-sebastian': pick(12, 16, 24),
  'asesoria-compra-asturias': pick(5, 14, 22),
  'asesoria-compra-santander': pick(6, 15, 21),
  'asesoria-compra-vitoria': pick(7, 12, 19),
  'asesoria-compra-san-sebastian': pick(8, 13, 25),
  'pack-arras-documental-asturias': pick(4, 10, 18),
  'pack-arras-documental-santander': pick(5, 11, 20),
  'pack-arras-documental-vitoria': pick(6, 12, 17),
  'pack-arras-documental-san-sebastian': pick(7, 13, 24),
  'pack-arras-vendedor-asturias': pick(9, 16, 22),
  'pack-arras-vendedor-santander': pick(8, 15, 21),
  'pack-arras-vendedor-vitoria': pick(7, 14, 19),
  'pack-arras-vendedor-san-sebastian': pick(10, 17, 25),
  ...
  'prestamo-particulares-alicante': pick(10, 3, 16),
  'prestamo-particulares-murcia': pick(11, 4, 18),
  'prestamo-particulares-granada': pick(12, 5, 19),
  'prestamo-particulares-coruna': pick(14, 6, 20),
  'prestamo-particulares-pamplona': pick(15, 7, 21),
  'prestamo-particulares-salamanca': pick(16, 8, 22),
  ...
  'alquiler-local-comercial-murcia': pick(9, 6, 4),
  'alquiler-local-comercial-granada': pick(10, 7, 11),
  'alquiler-local-comercial-coruna': pick(11, 8, 12),
  'alquiler-local-comercial-pamplona': pick(12, 9, 13),
  'alquiler-local-comercial-mallorca': pick(13, 10, 14),
  'alquiler-local-comercial-salamanca': pick(14, 11, 15),
  'alquiler-local-comercial-valladolid': pick(15, 12, 16),
